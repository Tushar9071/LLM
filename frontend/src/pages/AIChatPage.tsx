        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="mt-3 flex justify-between items-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <span className="font-medium">Target Language:</span> {user?.targetLanguage || 'Spanish'}
              </div>
            </div>
          </motion.div>
                ...
                <div className="flex items-end">
                  ...
                  <div className="flex ml-3 space-x-2">
                    <motion.button 
                      ...
                      className={`p-3 rounded-full ${isRecording ? 'bg-red-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'}`} 
                      disabled={isLoading} 
                    ...
                    <motion.button 
                      ...
                      whileHover={{ scale: 1.1, boxShadow: '0px 5px 15px rgba(37, 99, 235, 0.3)' }}
                      whileTap={{ scale: 0.9 }}
                    >
